...
int WINAPI wWinMain(_In_ HINSTANCE,_In_opt_ HINSTANCE ,_In_ LPWSTR,_In_ int)
{
	...
	DirectX::XMMATRIX transform = DirectX::XMMatrixTranspose(DirectX::XMMatrixRotationZ(190));

	c3d.SetShader(VertexShader(L"VertexShader.cso", { 
		
		{InputElemDesc::INPUT_FORMAT::FLOAT3 , "POSITION" , 0} ,
		{InputElemDesc::INPUT_FORMAT::FLOAT3 , "COLOR" , 12u}
		
		}, ConstBufferDesc{&transform , sizeof(transform)}));
